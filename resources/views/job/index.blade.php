            ...
            <form x-ref="filters" method="get" action="{{ route('jobs.index') }}" id="filtering-form">
                <div class="row">
                    <div class="col-6">
                        ...
                        <x-text-input name="search" value="{{ request('search') }}" placeholder="Search for a job title" form-ref="filters" />
                    </div>
                    <div class="col-6">
                        <span class="form-text">Salary</span>

                        <div class="d-flex flex-row">
                            <x-text-input name="min_salary" value="{{ request('min_salary') }}" placeholder="From" class="me-2" form-ref="filters" />
